...
describe('Limit calculation - test', () => {
  it('calcBuy - limit invalid', () => {
    ...
    expect(() => calcBuy(book, 0.3)).toThrow(new Error('Limit value is required'));
  });
  ...
  it('calcBuy test', () => {
    ...
    const result = calcBuy(book, 0.3, 200);
  ...
  it('calcSell - limit invalid', () => {
    ...
    expect(() => calcSell(book, 0.3)).toThrow(new Error('Limit value is required'));
  });
  ...
  it('calcSell test', () => {
    ...
    const result = calcSell(book, 0.3, 2500);
